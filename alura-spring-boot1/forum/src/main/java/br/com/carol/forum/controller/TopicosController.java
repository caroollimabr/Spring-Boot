...
public class TopicosController {
	...
	public List<TopicoDto> lista(String nomeCurso) { //com DTO (data transfer obj), há mais flexibilidade para mexer com a lista, não se deve trabalhar com a entidade
		if (nomeCurso == null) {
			List<Topico> topicos = topicoRepository.findAll();
			//conversao de topico para topicoDto
			return TopicoDto.converter(topicos); 
		} else {
			List<Topico> topicos = topicoRepository.findByCurso_Nome(nomeCurso); //pesquisa por nome dá para ser feita se gerado o método na interface
			//conversao de topico para topicoDto
			return TopicoDto.converter(topicos); 
		}
